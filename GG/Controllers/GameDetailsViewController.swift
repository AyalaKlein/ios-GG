...
class GameDetailsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        self.editGameButtonItem.isEnabled = self.userId == self.model.connectedUser()!.email!
    }
    ...
    @IBAction func deleteGame() {
        let alert = UIAlertController(title: "Delete Game", message: "Are you sure?", preferredStyle: UIAlertController.Style.alert)
